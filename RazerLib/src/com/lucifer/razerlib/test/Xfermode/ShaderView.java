...
public class ShaderView extends View
{
	...
	public ShaderView(Context context, AttributeSet attrs)
	{
		...
		// bottom - RECT_SIZE, Color.RED, Color.YELLOW,
		// Shader.TileMode.MIRROR));
		
		// mPaint.setShader(new LinearGradient(left, top, right, bottom, new
		// int[] { Color.RED, Color.YELLOW, Color.GREEN, Color.CYAN, Color.BLUE
