...
@SuppressLint("NewApi")
public abstract class BaseRefreshView extends Drawable implements
		Drawable.Callback, Animatable
{
	...
	/**
	 * Our animation depend on type of current work of refreshing. We should to
	 * do different things when it's end of refreshing
	 * 
	 * @param endOfRefreshing
	 *            - we will check current state of refresh with this
	 */
