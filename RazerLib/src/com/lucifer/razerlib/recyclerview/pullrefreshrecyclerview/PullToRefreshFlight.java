...
public class PullToRefreshFlight extends ViewGroup
{
    ...
    public PullToRefreshFlight(Context context)
    {
        this(context, null);
    }

    public PullToRefreshFlight(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        ...
        mRefreshView = new RefreshView(context, this);
