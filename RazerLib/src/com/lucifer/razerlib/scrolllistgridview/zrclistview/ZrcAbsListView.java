...
import com.lucifer.razerlib.scrolllistgridview.zrclistview.ZrcListView.OnScrollListener;
import com.lucifer.razerlib.scrolllistgridview.zrclistview.ZrcListView.OnScrollStateListener;
		...
		implements ViewTreeObserver.OnTouchModeChangeListener
{
	...
	public static final int[] NOTHING = new int[]
	{ 0 };
