...
public class RefreshLoadListView extends ListView implements OnScrollListener
{
	...
	public RefreshLoadListView(Context pContext, AttributeSet pAttrs)
	{
	...
	public RefreshLoadListView(Context pContext)
	{
		super(pContext);
		init(pContext);
	}
	...
	public RefreshLoadListView(Context pContext, AttributeSet pAttrs, int pDefStyle)
	{
