...
public class ListViewForScrollView extends ListView implements OnScrollListener
{
	...
	public ListViewForScrollView(Context context, AttributeSet attrs, int defStyle)
	{
		...
		final TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.ListViewForScrollView);
		final int scrollBarPanelLayoutId = a.getResourceId(
				R.styleable.ListViewForScrollView_scrollBarPanel, -1);
		final int scrollBarPanelInAnimation = a.getResourceId(
				R.styleable.ListViewForScrollView_scrollBarPanelInAnimation,
				R.anim.in_animation);
		final int scrollBarPanelOutAnimation = a.getResourceId(
				R.styleable.ListViewForScrollView_scrollBarPanelOutAnimation,
