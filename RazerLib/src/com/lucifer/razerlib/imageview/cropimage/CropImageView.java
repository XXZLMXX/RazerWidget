package com.lucifer.razerlib.imageview.cropimage;
...
public class CropImageView extends View
{
	...
	private final int STATUS_TOUCH_MULTI_START = 2;// ��㿪�?
	private final int STATUS_TOUCH_MULTI_TOUCHING = 3;// �����ק��?
	...
	protected float oriRationWH = 0;// ԭʼ��߱���?
	protected float maxZoomOut = 3.0f;// ������󵽶��ٱ�?
	protected float minZoomIn = 0.6666666f;// ��С��С�����ٱ�

	protected Drawable mDrawable;// ԭͼ
	protected FloatDrawable mFloatDrawable;// ����
	protected Rect mDrawableSrc = new Rect();
	protected Rect mDrawableDst = new Rect();
	protected Rect mDrawableFloat = new Rect();// ����ѡ��򣬾���ͷ��ѡ���
	...
	protected void configureBounds()
	{
		if (isFrist)
		{
			...
			int left = floatLeft;
			int top = floatTop;
			int right = floatLeft + newWidth;
			int bottom = floatTop + newHeight;
			minZoomIn = 1;
			maxZoomOut = 2;
	...
	public Bitmap getCropImage()
	{
		...
		Bitmap finalBitmap = Bitmap.createBitmap(screenShoot,
				mDrawableFloat.left, mDrawableFloat.top + titleBarHeight
						+ statusBarHeight, mDrawableFloat.width(),
